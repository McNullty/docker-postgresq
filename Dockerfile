...
RUN apt-get update && apt-get install -y python-software-properties libc6 libpq5 pgdg-keyring postgresql-9.3 postgresql-client-9.3 postgresql-client-common postgresql-common postgresql-contrib
